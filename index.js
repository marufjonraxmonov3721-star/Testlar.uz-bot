...
bot.start((ctx) => {
    return ctx.replyWithMarkdown(
        ...
        `Imtihonlarga tayyorlanish uchun pastdagi tugmani bosing:`,
...
// 2. Vercel va Cron-job so'rovlarini qabul qilish
module.exports = async (req, res) => {
    if (req.method === 'POST') {
        ...
        // Cron-job.org orqali shu yerga har 5 daqiqada so'rov keladi
